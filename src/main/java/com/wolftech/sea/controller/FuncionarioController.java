...
@Api(tags = "Funcionarios", description = "Rotas para operações com Funcionários")
public class FuncionarioController {
    ...
    @PostMapping("/filtrar")
    @ApiOperation("Retorna uma Lista de funcionários com base nos atributos da requisição.")
